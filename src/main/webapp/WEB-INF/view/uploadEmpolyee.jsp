...
<link
	...
	rel="stylesheet" />
<link rel="stylesheet"
	href="/HRManagement/resources/css/common.css">
...
<body>
	...
	%>
	<div class="userName">
		<b>Welcome <%=name%></b> <a href="/HRManagement/logout"> <ion-icon
		...
		<div class="panel panel-primary">
			<div class="panel-body">
				<h3 class="text-on-pannel text-primary">
					<strong class="text-uppercase"> Add New Employee </strong>
				</h3>
				
				<div class="form center">
					<form class="form-horizontal" action="addEmployee" method="post"
						name="empDetailsForm" id="empDetailsForm" onsubmit="return validateFrom()">
						
						<div class="form-group">
							<label class="control-label col-sm-4" for="emp-code">Employee
								code:</label>
							<div class="col-sm-3">
								<input type="number" class="form-control" id="emp-code"
									name="empCode" min="1" max="999" required>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-4" for="emp-name">Employee
								Name:</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" id="emp-name"
									name="empName" maxlenght="100" required>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="email" class="form-control" id="emp-email"
									name="empEmail" maxlenght="100" required>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-4" for="emp-dob">Date
								of Birth:</label>
							<div class="col-sm-8">
								<input type="date" class="form-control" id="emp-dob"
									name="empDOB" reuqired>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-2">
								<button type="button"
									onclick="window.location.href='/employeeManagement/home' "
	...
	<div id="footer">
		<p>
			<b>Copyright 2020-2021 by Fresher Training</b>
		</p>
	</div>
